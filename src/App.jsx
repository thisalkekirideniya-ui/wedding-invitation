      ...
      {isOpen && (
        <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
          ...
          <Section className="bg-white/40">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 max-w-5xl w-full px-4">
              <div className="space-y-4">
                <p className="text-sm tracking-widest uppercase font-bold opacity-50 text-villa-olive">Beloved Daughter of</p>
                <p className="font-serif text-2xl md:text-3xl font-bold">Mr. & Mrs. Rodrigo</p>
              </div>
              <div className="space-y-4">
                <p className="text-sm tracking-widest uppercase font-bold opacity-50 text-villa-olive">Beloved Son of</p>
            ...
            <div className="flex gap-4 md:gap-12 justify-center flex-wrap">
              {Object.entries(timeLeft).map(([label, val]) => (
                <div key={label} className="flex flex-col items-center">
                  ...
                  <p className="text-[10px] md:text-xs uppercase tracking-widest font-bold opacity-60 text-villa-olive">{label}</p>
                </div>
              ))}
            </div>
          ...
          <Section className="bg-white/40">
            ...
            <p className="text-xs tracking-[0.3em] uppercase font-bold opacity-40 mb-16 text-villa-olive">What we have planned for you</p>
            <div className="space-y-8 relative w-full max-w-2xl px-6">
              ...
              {[
                ...
                <div key={idx} className="z-10 bg-villa-cream py-6 px-8 rounded-2xl border border-villa-olive/5 shadow-sm">
                  ...
                  <p className="text-sm md:text-base font-semibold opacity-60 mt-2 text-villa-olive font-bold">{item.desc}</p>
                </div>
              ))}
            </div>
          </Section>
          ...
          <Section>
            ...
            <div className="relative bg-white p-10 md:p-14 rounded-[2rem] md:rounded-[3rem] shadow-2xl max-w-xl mx-4">
              ...
              <p className="text-base font-semibold leading-relaxed opacity-70 mb-6 text-villa-olive font-bold">
          ...
          <Section className="bg-white/40">
            ...
            <p className="text-xs tracking-[0.2em] uppercase font-bold opacity-40 mb-12 text-villa-olive font-bold text-shadow-sm">We hope you can make it</p>
            <form className="w-full max-w-md space-y-10 text-left bg-white/60 p-8 md:p-12 rounded-[2.5rem] shadow-xl backdrop-blur-sm mx-4">
              ...
              <div className="space-y-2"><label className="font-serif text-lg font-bold">Full name *</label><input type="text" className="w-full bg-white/80 border-b-2 border-villa-olive/10 py-3 px-4 outline-none focus:border-villa-olive transition-all rounded-xl font-bold" placeholder="Your full name" /></div>
              <div className="space-y-2"><label className="font-serif text-lg font-bold">Contact Number *</label><input type="tel" className="w-full bg-white/80 border-b-2 border-villa-olive/10 py-3 px-4 outline-none focus:border-villa-olive transition-all rounded-xl font-bold" placeholder="+94 77 000 0000" /></div>
              <button type="button" className="w-full bg-villa-olive text-white py-5 rounded-full font-bold tracking-[0.2em] shadow-lg active:scale-95 transition-all mt-6 uppercase text-sm font-bold">Submit Response</button>
            </form>
          </Section>
          ...
          <Section>
            ...
            <div className="w-full max-w-lg bg-white/80 p-8 md:p-12 rounded-[2.5rem] shadow-xl mx-4">
                <textarea className="w-full bg-villa-cream/50 border-2 border-villa-olive/10 py-4 px-6 outline-none focus:border-villa-olive transition-all rounded-[1.5rem] font-bold h-48 resize-none shadow-inner" placeholder="Leave a heartfelt message..."></textarea>
                <button className="w-full bg-villa-olive text-white py-5 rounded-full font-bold tracking-[0.2em] shadow-lg mt-8 uppercase text-sm font-bold">Post Message</button>
            </div>
          </Section>
          ...
          <Section className="pb-24">
            <div className="max-w-2xl px-6">
                ...
                <p className="font-serif text-xl md:text-2xl italic font-bold leading-relaxed opacity-80 mb-12 text-villa-olive">
